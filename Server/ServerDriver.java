...
public class ServerDriver {
    ...
    public static void main(String[] args) {
        ...
        // System.out.print("Path to Server.java file: ");
        // String pathToServer = sc.nextLine();
        String pathToServer = "C:/Users/aksha/Coding/Java/Bank/Server/ServerCreater.java";

        String command = "java " + pathToServer;
